-- hnsw_edge_cases.sql — Edge cases for GPU HNSW operations.
--
-- Tests:
--   1. Small index (n_vecs < 16): cpu_hnsw_fallback gracefully uses GPU CAGRA.
--   2. VACUUM on GPU-built HNSW — must complete without error.
--   3. REINDEX on GPU-built HNSW — rebuilds via pgvector CPU path.
--
...
-- ============================================================
-- Case 1: small index (4 vecs) — cpu_hnsw_fallback falls back to GPU.
-- ============================================================
...
-- ============================================================
-- Case 2: VACUUM on GPU-built HNSW — must complete without error.
-- ============================================================
...
SELECT pg_cuvs_build_hnsw('ec_ddl_cagra'::regclass) IS NOT NULL AS hnsw_created;
...
-- ============================================================
-- Case 3: REINDEX on GPU-built HNSW — rebuilds via pgvector CPU path.
-- ============================================================
REINDEX TABLE ec_ddl;
