...
| **flat 라우팅 캘리브레이션** | Tier-2 측정 → `cuvs.gpu_bruteforce` off→auto 승격(ADR-069 루프). flat B 완료(완료 표 참조) — 다음 순차 작업 | 순차 (B 완료) |
