...
**날짜**: 2026-06-12
**상태**: ACCEPTED / 방향 기록 (실행은 ADR-026 트리거 충족 시). 근거: PHASE_3B_SPIKE.md, ADR-025/026, ADR-061. **2026-07-24 개정 — 방향 3 철회, 신규 방향 4(포팅) 채택. 아래 "개정" 절 참조.**
...
| 조각 | 우리 상태 |
|---|---|
| Vamana 그래프 | cuVS 제공. in-memory 라운드트립 recall 0.999 (PHASE_3B_SPIKE.md) |
...
> `ROADMAP.md` 3B 행, `design/PLAN.md` Phase 3B 항목에서 자라난 것이며, 그 세 곳 중
