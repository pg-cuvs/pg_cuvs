...
### Item 1 — 정식화 완료 (#32)
`test/sql/partition_prune.sql` + golden(결정적: pruned=단일 child Index Scan, confinement, IN(2,3)=2파티션, 무필터=fan-out) + `infra/scripts/tenant-partition-recipe.sql`. REGRESS 18/18 GREEN.
