...
`read_fbin` exists in 9 copies across `bench/` (`cuvs_bench_backend/`, `filter_recall/`,
`legacy/`, `legacy/anbench/`, `protocol/spikes/`); recall in
