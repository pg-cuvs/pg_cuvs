...
| 3 — Scale Out | pending-delta correction, DiskANN/Vamana, object-storage snapshots, replicas, multi-GPU | In progress (3A/3C/3D/3E/3F done; true sharding verified on 2x A100; 3G optimization + 3B DiskANN pending) |
