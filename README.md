...
| 3 — Scale Out | pending-delta correction, DiskANN/Vamana, object-storage snapshots, replicas, multi-GPU | In progress (3A/3C/3D/3E MVP done; 3F true sharding + 3B DiskANN pending) |
