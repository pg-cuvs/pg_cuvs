...
| 3 — Scale Out | pending-delta correction, DiskANN/Vamana, object-storage snapshots, replicas, multi-GPU | In progress (3A/3C/3D done; 3E-1 placement verified; 3E policy/integration + 3B pending) |
