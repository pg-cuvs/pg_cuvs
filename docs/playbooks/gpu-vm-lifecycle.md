...
```bash
gcloud compute instances reset pg-cuvs-dev --zone=us-central1-b --project=gpu-experiment-wdl-2026
...
```bash
PROJ=gpu-experiment-wdl-2026; Z=us-central1-b
...
# 예상: gpu-exp-may@gpu-experiment-wdl-2026.iam.gserviceaccount.com
```
